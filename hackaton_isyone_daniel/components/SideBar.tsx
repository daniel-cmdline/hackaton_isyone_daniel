...
interface SidebarProps {
  activeTab: "scripts" | "tokens";
  setActiveTab: (tab: "scripts" | "tokens") => void;
  user: {
    name?: string | null;
    email?: string | null;
  };
    ...
    <aside className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col justify-between p-6">
      <div className="space-y-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-indigo-400 font-mono text-lg leading-none">ISYONE</h1>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold">Automation Hub</p>
          </div>
        </div>

        <nav className="space-y-2">
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider px-3 mb-2">Gerenciamento</p>
      ...
      <div className="border-t border-zinc-800 pt-4 flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="overflow-hidden">
            <p className="text-xs font-semibold text-zinc-200 truncate">{user.name || "Operador"}</p>
