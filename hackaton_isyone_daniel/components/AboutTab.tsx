    ...
    <div className="w-full max-w-4xl bg-black border border-zinc-900 p-6 md:p-8 font-mono text-left relative overflow-hidden shadow-2xl rounded-xl">
      ...
      <div className="relative z-10 border-b border-zinc-900 pb-4 mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="shrink-0 bg-zinc-950 border border-zinc-900 px-3 py-1 text-right text-[11px] text-zinc-500">
          ACCESS_TOKEN: <span className="text-emerald-400 font-bold">GRANTED</span>
        </div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-4 flex flex-col items-center md:items-stretch gap-4">
          ...
          <div className="w-full bg-zinc-950 border border-zinc-900 p-6 flex flex-col items-center justify-center rounded-xl relative group">
            ...
            {/* Moldura da sua foto */}
            <div className="w-32 h-32 rounded-full border-2 border-emerald-500/30 overflow-hidden shadow-[0_0_25px_rgba(16,185,129,0.15)] bg-zinc-900 flex items-center justify-center relative mb-4 group-hover:border-emerald-400 transition-all duration-300">
              <img 
              ...
              />
              {/* Overlay verde invisível que acende no hover */}
            ...
            <p className="text-[11px] text-zinc-300 font-bold tracking-wider">DANIEL CAESAR M.</p>
            <p className="text-[9px] text-zinc-600 tracking-widest uppercase mt-0.5">@ROOT_OPERATOR</p>
          </div>

          {/* Links Sociais Criptografados */}
          <div className="w-full bg-zinc-950 border border-zinc-900 p-4 space-y-2 rounded-xl">
            <p className="text-[9px] font-black text-zinc-600 uppercase border-b border-zinc-900 pb-1">// COMMUNICATIONS</p>
            <div className="flex flex-col gap-1.5 pt-1">
              <a 
                href="https://github.com/daniel-cmdline" // ➔ Mete teu link real aqui
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-[11px] border border-zinc-900 bg-black hover:border-emerald-500/40 p-2 text-center text-zinc-500 hover:text-emerald-400 hover:bg-emerald-950/5 transition-all duration-150 rounded-lg font-bold"
              >
        ...
        <div className="lg:col-span-8 space-y-4 w-full">
          ...
          <div className="bg-zinc-950 border border-zinc-900 p-4 space-y-3 rounded-xl">
            <p className="text-[9px] font-black text-zinc-600 uppercase border-b border-zinc-900 pb-1">// CORE_DOSSIER</p>
            <div className="grid grid-cols-2 gap-2 text-xs text-zinc-400 pb-2 border-b border-zinc-900/60 font-sans">
              <p><span className="font-mono text-[10px] text-zinc-600 font-bold">STACK:</span> Full-Stack / Infra</p>
              <p><span className="font-mono text-[10px] text-zinc-600 font-bold">LOCATION:</span> São Paulo, BR</p>
              <p><span className="font-mono text-[10px] text-zinc-600 font-bold">SYS_NATIVE:</span> Linux Terminal</p>
              <p><span className="font-mono text-[10px] text-zinc-600 font-bold">STATUS:</span> Active Operator</p>
            </div>
            <p className="text-xs text-zinc-400 font-sans leading-relaxed pt-1">
              Desenvoledor Web e estudante de Segurança Cibernética e Redes, focado na arquitetura de automações e resiliência de infraestrutura. Orientado a detalhes e na construção de soluções e sistemas otimizados. Usuário Linux e Perfeccionista por diretriz técnica valorizando sempre a integridade de dados e a operação.
            </p>
          </div>

          {/* Barras de Skills em Formato ASCII */}
          <div className="bg-zinc-950 border border-zinc-900 p-4 space-y-4 rounded-xl">
            <p className="text-[9px] font-black text-zinc-600 uppercase border-b border-zinc-900 pb-1">// INFRASTRUCTURE_CAPACITANCE</p>
            ...
            <div className="space-y-3 text-[11px]">
              <div>
                ...
                <div className="text-emerald-500/30 tracking-tighter bg-black border border-zinc-900/60 p-0.5 font-bold rounded">
                  [███████████████████░]
                </div>
              </div>
